        ...
        <div className='container'>
          <div className='row align-items-center justify-content-center procedure-detail'>
            <div className='col-md-12'>
              <div className='row'>
                <div className='col-md-12'>
                  <h5>
                    ...
                    reemplazo de software de máquina registradora o sistema computarizado, así como
                    autorización de cinta de auditoría o bitácora y emisión de documenttos
                    preimpresos
                  </h5>
                </div>
              </div>
              ...
              <div className='row'>
                <div className='col-md-12'>
                  <p>Sujetos obligados: Comerciantes que inician operación y deben registrar sus máquinas</p>
                </div>
              </div>
              <div className='row'>
                <div className='col-md-4'>
                          ...
                          <div id='procedureCollapse1'
                            ...
                            <div className='card-body'>
                              <p>
                                ...
                                <i className='fas fa-clock'></i> Lun - Dom 06:00 am - 10:00pm <br />
              ...
              <div className='row'>
                <div className='col-md-12'>
                  ...
                  <ol type='a'>
                    <li>
                      Solicitud de traslado, especificando las carasterísticas del equipo y la nueva
                      dirección
                    </li>
